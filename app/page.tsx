...
export default function LandingPage() {
  ...
  // カート内の「分別済み」商品の割合でボーナス変動させても面白いが、ここではシンプルに
          ...
          <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-sm relative">
            ...
            {loginTab === 'login' ? (
              ...
              <div className="space-y-4">
                ...
                <button 
                  onClick={() => handleRegister((document.getElementById('regCode') as HTMLInputElement).value, (document.getElementById('regName') as HTMLInputElement).value)} 
